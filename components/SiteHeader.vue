<template>
  <header class="bg-gray-900 sm:flex sm:items-center sm:justify-between xl:bg-white">
    <div
      class="flex justify-between bg-gray-900 px-4 py-3 xl:w-72 xl:bg-gray-900 xl:justify-center xl:py-5"
    >
      <div>
      ...
      <div class="flex sm:hidden" :class="{ antialiased: isOpen }">
        ...
        >
          <svg
            class="h-6 w-6 fill-current items-center"
            aria-hidden="true"
            focusable="false"
            data-prefix="fas"
            data-icon="bars"
    ...
    <nav
      class="sm:flex sm:items-center xl:flex-1 xl:justify-between"
      :class="{ hidden: !isOpen, block: isOpen }"
    >
      <div class="ml-4 hidden xl:block">
        <div class="relative max-w-sm w-full">
          <div class="absolute inset-y-0 left-0 pt-2 pl-3">
          ...
          <input
            class="block w-full border border-transparent bg-gray-300 text-gray-900 rounded-lg pl-10 pr-4 py-2 focus:outline-none focus:bg-white focus:text-gray-900 focus:border-gray-400"
      ...
      <div class="px-2 pt-2 pb-5 border-b border-gray-800 sm:flex sm:border-b-0 sm:py-0">
        <a
          href="#"
          class="mt-1 px-3 rounded py-1 block leading-tight font-semibold text-white hover:bg-gray-800 sm:mt-0 sm:text-sm sm:px-2 xl:text-gray-900"
        >List your property</a>
        <a
          href="#"
          class="mt-1 px-3 rounded py-1 block leading-tight font-semibold text-white hover:bg-gray-800 sm:mt-0 sm:text-sm sm:px-2 sm:ml-2 xl:text-gray-900"
        >Trips</a>
        <a
          href="#"
          class="mt-1 px-3 rounded py-1 block leading-tight font-semibold text-white hover:bg-gray-800 sm:mt-0 sm:text-sm sm:px-2 sm:ml-2 xl:text-gray-900"
        ...
        <div class="pr-2 pl-4">
          <img
            class="h-8 w-8 rounded-full object-cover border-gray-600 border-2 xs:hidden xl:border-gray-300"
      ...
      <div class="px-5 py-5 xs:hidden">
        <div class="flex items-center">
          <img
            class="h-10 w-10 rounded-full object-cover border-gray-600 border-2"
            src="https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1651&q=80"
          />
        ...
        <div class="mt-5">
          <a
            href="#"
            class="mt-3 block leading-tight font-normal text-gray-400 hover:text-white"
          >Account Settings</a>
          <a
            href="#"
            class="mt-3 block leading-tight font-normal text-gray-400 hover:text-white"
